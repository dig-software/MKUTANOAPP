...
const faqs = [
  ...
  { q: "How do members view their own savings?", a: "Members with a member account can log in and view their personal wallet — shares held, total contributions, active loans, repayment schedule, and savings history. They cannot edit any group data." },
